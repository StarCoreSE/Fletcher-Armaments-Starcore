...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FaTwin105mmT => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "105mmSKC33",  // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Scope = "Empty.001", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "10.7cm SK C33", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                SK105mmShell, // Must list all primary, shrapnel, and pattern ammos.
            },
