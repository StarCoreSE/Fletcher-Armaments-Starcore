...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FaACAD37mmRemodel => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "37mm70MLE",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "37mm MLE 1935 ACAD Remodel", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RateOfFire = 270, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "37mmAcadFire", // Audio for firing.
            ...
            Ammos = new[] {
                FAShell37mm,FAFlak37mmShrap // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = ACAD37mmRecoil,
