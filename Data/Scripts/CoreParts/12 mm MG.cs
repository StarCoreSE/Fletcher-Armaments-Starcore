...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FA12MG => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "12mmAirCannon",
            ...
            {
                PartName = "12mm Aircraft Machine Gun", // name of weapon in terminal
                ...
                Audio = new HardPointAudioDef {
                    PreFiringSound = "",
                    FiringSound = "12mmFire", // WepShipGatlingShot
