...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FaPomPom => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "QF4PomPom",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "QF4 Pom Pom", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
