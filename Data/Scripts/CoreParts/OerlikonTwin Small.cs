...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FaOerlikon20mmDualSmallRemodel => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "OerlikonDualSmall", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "20mm Oerlikon Dual Small", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                Oerlikon20mm,Oerlikon20mmHET,Oerlikon20mmAPT // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = OerlikonDualRecoil,
