...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FACaseMateTest => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "CasemateTest",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "CaseMateTest", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
