...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FA138mmMLERemodel => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "138mmMain",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "138.6mm 40 MLE 1927 Remodel", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                FA138mmShell, // Must list all primary, shrapnel, and pattern ammos.
            },
