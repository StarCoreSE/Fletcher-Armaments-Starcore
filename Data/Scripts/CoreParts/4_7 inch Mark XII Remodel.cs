...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FA120mmMk12Remodel => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "4_7InchMain",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "4.7 Inch Mark 12 Remodel", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                FA120mmShell, // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = FA5InchRecoilTwin,
