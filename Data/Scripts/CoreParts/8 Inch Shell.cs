...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef FA8InchShell => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "6InchShell", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "8-InchHE", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                ...
                Degrees = 5, // Cone in which to randomise direction of spawned projectiles.
