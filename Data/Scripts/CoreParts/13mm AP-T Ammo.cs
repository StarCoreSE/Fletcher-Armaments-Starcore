...
{ // Don't edit above this line
 ...
 private AmmoDef Hotch13mmAPT => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "13mmAmmoBox", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "13.2 AP-T", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            AmmoGraphics = new GraphicDef
            {
                 ...
                 Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 9f,
                        Width = 0.05f,
                        Color = Color(red: 20.0f, green: 20.0f, blue: 20.0f, alpha: 0.8f),
                    },
                    Trail = new TrailDef
                    {
                        Enable = false,
