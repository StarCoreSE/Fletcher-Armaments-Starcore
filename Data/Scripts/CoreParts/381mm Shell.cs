...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef FA381mmShell => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "381mmShell", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "381mmHEShell", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                AmmoRound = "381mmShrap", // AmmoRound field of the ammo to spawn.
                Fragments = 75, // Number of projectiles to spawn.
                Degrees = 100, // Cone in which to randomise direction of spawned projectiles.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxTrajectory = 5700f, // Max Distance the projectile or beam can Travel.
