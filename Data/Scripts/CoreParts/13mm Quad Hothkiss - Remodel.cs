...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FaHotch13mmQuadRemodel => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "13mmQuad",  // Block Subtypeid. Your Cubeblocks contain this information
                        ...
                        IconName = "13mmHotchkiss_Icon.dds" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },
            ...
            {
                PartName = "13mm Quad Hotchkiss", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "13.2mmFire", // Audio for firing.
            ...
            Ammos = new[] {
                Hotch13mmA,Hotch13mmAPT,Hotch13mmHET // Must list all primary, shrapnel, and pattern ammos.
            },
