...
{ // Don't edit above this line
 ...
 private AmmoDef Oerlikon20mm => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "20mmDrum", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "20mm Oerlikon", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            Pattern = new PatternDef
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire in order instead of the main ammo.
                    "20mm HE-T", "20mm HE-T", "20mm AP-T", "20mm HE-T", "20mm AP-T", "20mm HE-T",
                },
                Enable = true,
            ...
            AmmoGraphics = new GraphicDef
            {
                 ...
                 Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 8f,
                        Width = 0.02f,
                        Color = Color(red: 25.5f, green: 6.0f, blue: 0f, alpha: 0.5f),
                    },
                    Trail = new TrailDef
                    {
                        Enable = false,
