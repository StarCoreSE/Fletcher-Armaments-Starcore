...
{ // Don't edit above this line
 ...
 private AmmoDef Hotch13mmA => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "13mmAmmoBox", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "13.2 x 9mm 40rd", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            Pattern = new PatternDef
            {
                Patterns = new[] { // If enabled, set of multiple ammos to fire in order instead of the main ammo.
                    "13.2 AP-T", "13.2 AP-T", "13.2 HE-T", "13.2 AP-T", "13.2 HE-T",
                },
                Enable = true,
