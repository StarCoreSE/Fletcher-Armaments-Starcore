...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef FA5InchShellAA => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "5InchShell", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Anti-Air Shell", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                AmmoRound = "5InchAAShrap", // AmmoRound field of the ammo to spawn.
