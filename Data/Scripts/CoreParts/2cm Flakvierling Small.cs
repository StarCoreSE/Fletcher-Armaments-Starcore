...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FaFlak2cm38RemodelSmall => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "2cmFlakQuadSmall",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "2cm Flakvierling Remodel", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
