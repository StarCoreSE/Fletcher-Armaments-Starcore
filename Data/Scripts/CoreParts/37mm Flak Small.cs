...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FaFlak37mmSmallRemodel => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "37mmFlakDualSmall",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "37mm Flak", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "37mmFire", // Audio for firing.
            ...
            Ammos = new[] {
                FAFlak37mmShell,FAFlak37mmShrap // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = Flak37mmRecoil,
