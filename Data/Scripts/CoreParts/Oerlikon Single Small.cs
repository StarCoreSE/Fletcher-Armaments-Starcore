...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FaOerlikon20mmSmallRemodel => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "OerlikonMainSmall", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "20mm Oerlikon Single Small", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
