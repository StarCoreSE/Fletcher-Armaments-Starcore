...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FA16InchGunRemodel => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "16InchGun",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "16 Inch Gun Redux", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
