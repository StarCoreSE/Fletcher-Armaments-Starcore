...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FA8Inch55 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "8Inch55Main",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "8-Inch 55 MK 9", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                FA8InchShell,FA8InchAPShell,FA6InchShrap, // Must list all primary, shrapnel, and pattern ammos.
            },
