...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FaHotchQuad13mm => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "13mmCAQMLE1929",  // Block Subtypeid. Your Cubeblocks contain this information
                        ...
                        IconName = "13mmHotchkissCAQ_Icon" // Overlay for block inventory slots, like reactors, refineries, etc.
                    },
            ...
            Ammos = new[] {
                Hotch13mmA, // Must list all primary, shrapnel, and pattern ammos.
            },
