...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FaBoforSingleSmallRemodel => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "BoforSingleRemodelSmall", // Block Subtypeid. Your Cubeblocks contain this information
