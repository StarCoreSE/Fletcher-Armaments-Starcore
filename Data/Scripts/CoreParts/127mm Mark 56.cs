...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FA127mmMK56 => new WeaponDefinition
        {
            ...
            {
                PartName = "5-Inch Mark 56 Rapid Fire", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
