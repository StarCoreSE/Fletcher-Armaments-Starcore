...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FaMLE37mm => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "37mmMLE1933",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "37mm MLE 1933", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
