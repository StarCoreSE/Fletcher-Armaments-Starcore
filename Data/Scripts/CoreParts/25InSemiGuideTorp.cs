    ...
    partial class Parts
    {
        ...
        private AmmoDef SemiGuidedTorp => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                TargetLossDegree = 0f, // Degrees, Is pointed forward
                TargetLossTime = 0, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                MaxLifeTime = 480, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). Please have a value for this, It stops Bad things.
                AccelPerSec = 0f, // Meters Per Second. This is the spawning Speed of the Projectile, and used by turning.
        ...
        private AmmoDef TorpLaunchStage => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                {
                    Enable = true,
                    Radius = 17.5f, // Radius of AOE effect, in meters.
                    Damage = 1000000f,
