...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FaFlak38SmallRemodel => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "FL2cmSmall", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "2Cm Flak 38", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RateOfFire = 280, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "2CmFlakFire", // Audio for firing.
            ...
            Ammos = new[] {
                FlakRound,FAFlakFrag // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = Flak38Recoil,
