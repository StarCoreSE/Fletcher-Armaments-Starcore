...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FaBoforQuad => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "40mmQuadBofors",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "40mm Bofors Quad", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                Bofor40mm,Bofor40mmShrap // Must list all primary, shrapnel, and pattern ammos.
            },
