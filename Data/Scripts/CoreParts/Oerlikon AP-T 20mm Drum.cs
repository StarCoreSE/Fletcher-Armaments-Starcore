...
{ // Don't edit above this line
 ...
 private AmmoDef Oerlikon20mmAPT => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "20mmDrum", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "20mm AP-T", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 35f, // Direct damage; one steel plate is worth 100.
            ...
            AmmoGraphics = new GraphicDef
            {
                 ...
                 Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 8f,
                        Width = 0.02f,
                        Color = Color(red: 20.0f, green: 20.0f, blue: 20.0f, alpha: 0.5f),
                    },
                    Trail = new TrailDef
                    {
                        Enable = false,
