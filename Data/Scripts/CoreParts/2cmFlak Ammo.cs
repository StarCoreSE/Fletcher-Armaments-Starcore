...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef FlakRound => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "2cmClip", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "2cm Flak Round", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                AmmoRound = "FlakFrag", // AmmoRound field of the ammo to spawn.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 1,
                    CustomParticle = "ExplosionSmall", // Particle SubtypeID, from your Particle SBC
                    CustomSound = "FlakExplosion", // SubtypeID from your Audio SBC, not a filename
                }, 
            },
            Ewar = new EwarDef
            {
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                RangeVariance = Random(start: 100, end: 2500), // subtracts value from MaxTrajectory
