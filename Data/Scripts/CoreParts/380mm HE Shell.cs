...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef FA380mmShell => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            Health = 350, // How much damage the projectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                ...
                Degrees = 35, // Cone in which to randomise direction of spawned projectiles.
