...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FaTwin100MM => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "100mmMLE1930HAT",  // Block Subtypeid. Your Cubeblocks contain this information
                ...
                Scope = "camera.001", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "100mm/45 MLE 1931 Twin", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
