...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FAHvarRemodelWC => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "127HvarMain",
            ...
            {
                PartName = "Hvar Rack Remodel", // name of weapon in terminal
                ...
                Audio = new HardPointAudioDef {
                    PreFiringSound = "",
                    FiringSound = "127mmHVARLaunch", // WepShipGatlingShot
