...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef FA203mmShell => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "203mm501931_HEShell", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "203mmHE", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 252f, // Direct damage; one steel plate is worth 100.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                   Enable = true,
                    ...
                    NoSound = false,
                    ParticleScale = 1f,
                    CustomParticle = "Explosion_AmmunitionMedium",
