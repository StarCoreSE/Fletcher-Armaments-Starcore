...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FA138mmMLE => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "138mmMLE1927",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "138.6mm 40 MLE 1927", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
