...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FA127mmMk30Remodel => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "5InchMk30Main",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "5-Inch Mark 30 Remodel", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                FA5InchShell,FA5InchShrap,FA5InchShellAA,FA5InchAAShrap // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = FA5InchRecoilMK12,
