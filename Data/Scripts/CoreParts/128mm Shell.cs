...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef FA128mmShell => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "128mmShell", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "128mm Shell", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Armor = new ArmorDef
                {
                    ...
                    NonArmor = 0f, // Multiplier for damage against every else.
                },
            ...
            {
                ModelName = "\\Models\\128mmShellFired_Small.mwm",
