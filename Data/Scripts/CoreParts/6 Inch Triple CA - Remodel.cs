...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FA6Inch47Remodel => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "6InchMain",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "6 Inch Remodel", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                FA6InchShell,FA6InchAPShell,FA6InchShrap, // Must list all primary, shrapnel, and pattern ammos.
            },
            Animations = FA6InchRecoil,
