...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FaOerlikon20mmTwin => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "20mmOerlikonDouble", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "20mm Oerlikon Twin", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                {
                    RateOfFire = 475, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "AAGenericShot", // Audio for firing.
            ...
            Ammos = new[] {
                Oerlikon20mm, // Must list all primary, shrapnel, and pattern ammos.
            },
