...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FA128mmC34Remodel => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "128C34Main",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "12.8cm SK C34 Remodel", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                FA128mmShell, // Must list all primary, shrapnel, and pattern ammos.
            },
