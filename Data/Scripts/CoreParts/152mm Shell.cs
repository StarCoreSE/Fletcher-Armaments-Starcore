...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef FA152mmShell => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "152mmMLEShell", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "152mmShellAPHE", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 2120f, // Direct damage; one steel plate is worth 100.
            ...
            {
                AmmoRound = "152mmShrap", // AmmoRound field of the ammo to spawn.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5f,
                        Width = 0.1f,
                        Color = Color(red: 20.80f, green: 40.20f, blue: 1.6f, alpha: 1.8f),
                    },
                    Trail = new TrailDef
                    {
                        Enable = true,
                        ...
                        DecayTime = 15,
                        Color = Color(red: 3.585f, green: 2.062f, blue: 5.01f, alpha: 0.3f),
                        Back = false,
                        CustomWidth = 0.1f,
