...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FA152mmMLE1936 => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "152mmMLE1936HA",  // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "152mm MLE 1930", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    MagsToLoad = 15, // Number of physical magazines to consume on reload.
            ...
            Ammos = new[] {
                FA152mmShell,FA152mmShrap // Must list all primary, shrapnel, and pattern ammos.
            },
